...
| 8 | `update.md:133-182` | Create `tools/kb-check.sh` + sample `tools/hooks/pre-commit` if missing |
| 9 | `update.md:183` | Bump "last indexed" in `kb/overview.md` |

## Rules

- Incremental only — do not regenerate unchanged KB files (`update.md:185-190`).
