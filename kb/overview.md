...
- **See also:** [[architecture]] (layout + data flow), [[prompt-init]] / [[prompt-update]] / [[prompt-verify]] / [[prompt-slim]] / [[prompt-check]] / [[prompt-hooks]] (the six prompts), [[kb-agents]] (the `.claude/agents/` subagents), [[about-you]] (user map), [[cheatsheet]], [[edit-a-prompt]] (edit runbook), [[gotchas]], [[changelog]], [[glossary]].
- **last indexed:** 2026-06-30 / v2.16 — full version history in [[changelog]] (single source of truth; not duplicated here).
